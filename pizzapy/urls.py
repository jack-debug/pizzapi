...
class Urls(object):
    ...
    def __init__(self, country=COUNTRY_USA):
        ...
        self.urls = {
            COUNTRY_USA: {
                'find_url' : 'https://order.dominos.com.au/power/store-locator?s={line1}&c={line2}&type={type}',
                'info_url' : 'https://order.dominos.com.au/power/store/{store_id}/profile',
                'menu_url' : 'https://order.dominos.com.au/power/store/{store_id}/menu?lang={lang}&structured=true',
                'place_url' : 'https://order.dominos.com.au/power/place-order',
                'price_url' : 'https://order.dominos.com.au/power/price-order',
                'track_by_order' : 'https://trkweb.dominos.com.au/orderstorage/GetTrackerData?StoreID={store_id}&OrderKey={order_key}',
                'track_by_phone' : 'https://trkweb.dominos.com.au/orderstorage/GetTrackerData?Phone={phone}',
                'validate_url' : 'https://order.dominos.com.au/power/validate-order',
                'coupon_url' : 'https://order.dominos.com.au/power/store/{store_id}/coupon/{couponid}?lang={lang}',
            },
            COUNTRY_CANADA: {
